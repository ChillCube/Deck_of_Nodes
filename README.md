...
```bash
clone-gd-addon https://github.com/ChillCube/Deck of Nodes.git
```
> [!IMPORTANT]
> Make sure to enable the addon, including its dependencies in the project settings!

## Documentation
You can find the documentation at: https://github.com/ChillCube/Deck of Nodes/blob/main/DOCUMENTATION.md

## Deinstallation
### Linux
Run this in the root of your godot project:
```bash
remove-gd-addon Deck of Nodes
```
